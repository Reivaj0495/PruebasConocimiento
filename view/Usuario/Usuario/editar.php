...
<form rule="formEditarUsuario" name="formEditarUsuario" id="formEditarUsuario" action="postCrearUsuario" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group">   
            ...
            <div class="form-group col-md-5">
                ...
                <?php foreach ($roles as $key => $val) { ?>
                    <div class="radio">
                        <label>
                            <input type="radio" name="rol" id="rol" value="<?php echo $val['id']; ?>" checked>
                            <?php echo $val['nombre']; ?>
                        </label>
                    </div>
                <?php } ?>
